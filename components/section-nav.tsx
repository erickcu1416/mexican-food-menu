...
const sections = [
  ...
  { id: "bebidas", label: "Bebidas", activeClass: "bg-amarillo text-foreground" },
      ...
      <div className="flex items-center justify-center gap-1.5">
        {sections.map(({ id, label, activeClass }) => (
          <button
            ...
            className={`whitespace-nowrap rounded-full px-4 py-2.5 text-xs font-sans font-medium transition-all duration-200 ${
              activeId === id
                ? activeClass

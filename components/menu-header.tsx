...
export function MenuHeader() {
  return (
    <header className="relative overflow-hidden pt-6 pb-4 md:pt-10 md:pb-6">
      {/* Floral corners - blend into background with mix-blend-multiply */}
      <div
      ...
      >
        ...
        <img src="/images/floral-corner-tl.jpg" alt="" className="w-full h-full object-contain mix-blend-multiply" />
      </div>
      <div
